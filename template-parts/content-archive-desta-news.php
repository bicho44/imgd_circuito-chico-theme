...
<div class="botones">
    <a href="#consulta-<?php the_ID(); ?>"
        class="btn btn--consulta"><?php _e('Consulta por esta actividad', 'imgd'); ?></a>
    <?php if ($link_compra!="") { ?>
    <a href="<?php echo $link_compra; ?>"
        class="btn btn--vermas"><?php echo get_post_meta(get_the_ID(), 'imgd_texto_link_compra_field', true);?></a>
    <?php }; ?>

    <!-- Acá va el Modal de la consulta por <?php the_title();?> -->
    <section class="modal--show" id="consulta-<?php the_ID(); ?>"
